...
\begin{frame}{Lensing distorts the CMB}
	\begin{center}
		\only<1>{\includegraphics[height=7cm]{plots/maps/T.png}}%
		\only<2>{\includegraphics[height=7cm]{plots/maps/TlT.png}}%
		\only<3-4>{\includegraphics[height=7cm]{plots/maps/TsT.png}}%
