...
\begin{frame}{Summary}
	\begin{center}
		...
		\end{itemize}
		\uncover<5->{\includegraphics[height=4cm,clip,trim=7mm -3mm 8mm 8mm]{plots/planck_lens_spec.pdf}}
		\uncover<6->{\includegraphics[height=4.2cm,clip,trim=6mm 32mm 0mm -8mm]{plots/cmb_lensing_past_future_blake.png}}
	\end{center}
\end{frame}
